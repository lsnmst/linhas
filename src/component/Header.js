    ...
    return <div style={{width:"100%"}}>
      ...
      <div className="bemvindo-box">
        <div className="bemvindo-claim">
          <h1>Imagine andar de ônibus na madrugada ou à noite para ir <i>alimentar</i> os bairros ricos da cidade ou dar um rolezinho na praia, e depois acabar no meio de um tiroteio, ter que pular pela janela porque o ônibus está pegando fogo ou não correr o risco de se sufocar com o calor, ser parado pela polícia por conta da cor da pele ou ser assaltado.<br /><b>LINHAS</b> é um arquivo que traz as histórias dos ônibus que trabalhadorxs e moradorxs lotam todos os dias, <span style={{backgroundColor:"#66bee770"}}>vítimas da violência urbana</span>, <span style={{backgroundColor:"#66e7e170"}}>da discriminação e do racismo</span>, <span style={{backgroundColor:"rgba(224, 96, 248, 0.4)"}}>de assédio sexual</span>, <span style={{backgroundColor:"rgba(162,153,237,.5)"}}>de eventos climáticos extremos</span>, <span style={{backgroundColor:"#f0f55b70"}}>da negligência ou da falta de manutenção</span>, <span style={{backgroundColor:"#fad76170"}}>de falta de alternativas</span>. E mostra como a cidade se descloca quando o carioca inventa uma maneira de <span style={{backgroundColor:"rgba(255,106,106,.4)"}}>celebrar</span> numa cidade marcada pela repressão institucional.</h1>
        </div>
      </div>
